...
val_t standard___environ___String___environ(val_t p0){
  ...
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/environ.nit:26 */
  ...
  /* ../nit/lib/standard/environ.nit:28 */
  if (!once_value_1) {
    if (!once_value_2) {
  ...
  fra.me.REG[1] = fra.me.REG[1];
  /* ../nit/lib/standard/environ.nit:29 */
...
val_t standard___environ___NativeString___get_environ(val_t p0){
  ...
  fra.me.REG[0] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/environ.nit:38 */
