...
val_t standard___collection___sorter___AbstractSorter___compare(val_t p0, val_t p1, val_t p2){
  ...
  /* ../nit/lib/standard/collection/sorter.nit:22 */
...
void standard___collection___sorter___AbstractSorter___sort(val_t p0, val_t p1){
  ...
  fra.me.REG[0] = p0;
  fra.me.REG[1] = p1;
  /* ../nit/lib/standard/collection/sorter.nit:30 */
  REGB0 = TAG_Int(0);
...
void standard___collection___sorter___AbstractSorter___sub_sort(val_t p0, val_t p1, val_t p2, val_t p3){
  ...
  /* ../nit/lib/standard/collection/sorter.nit:35 */
  if (UNTAG_Bool(REGB2)) {
    /* ../nit/lib/standard/collection/sorter.nit:36 */
    goto label1;
  } else {
    /* ../nit/lib/standard/collection/sorter.nit:37 */
    REGB2 = TAG_Int(7);
...
void standard___collection___sorter___AbstractSorter___quick_sort(val_t p0, val_t p1, val_t p2, val_t p3){
  ...
  goto label1;
  label1: while(0);
  /* ../nit/lib/standard/collection/sorter.nit:48 */
  REGB2 = REGB0;
  /* ../nit/lib/standard/collection/sorter.nit:49 */
  REGB3 = REGB1;
  /* ../nit/lib/standard/collection/sorter.nit:50 */
  while(1) {
    ...
    /* ../nit/lib/standard/collection/sorter.nit:50 */
    if (UNTAG_Bool(REGB4)) {
      /* ../nit/lib/standard/collection/sorter.nit:51 */
      while(1) {
      ...
      label3: while(0);
      /* ../nit/lib/standard/collection/sorter.nit:52 */
      while(1) {
      ...
      /* ../nit/lib/standard/kernel.nit:237 */
      REGB4 = TAG_Bool(UNTAG_Int(REGB3)>UNTAG_Int(REGB2));
      /* ../nit/lib/standard/collection/sorter.nit:53 */
      if (UNTAG_Bool(REGB4)) {
        /* ../nit/lib/standard/collection/array.nit:278 */
        fra.me.REG[3] = fra.me.REG[1];
        REGB4 = REGB2;
  ...
  label8: while(0);
  /* ../nit/lib/standard/collection/sorter.nit:59 */
  REGB3 = TAG_Int(1);
  /* ../nit/lib/standard/kernel.nit:240 */
...
void standard___collection___sorter___AbstractSorter___bubble_sort(val_t p0, val_t p1, val_t p2, val_t p3){
  ...
  REGB0 = p2;
  REGB1 = p3;
  /* ../nit/lib/standard/collection/sorter.nit:69 */
  while(1) {
    REGB2 = TAG_Bool(VAL_ISA(REGB1, VTCOLOR_standard___kernel___Comparable___OTHER(REGB0), VTID_standard___kernel___Comparable___OTHER(REGB0))) /*cast OTHER*/;
    if (UNTAG_Bool(REGB2)) {
    } else {
    ...
    /* ../nit/lib/standard/collection/sorter.nit:69 */
    if (UNTAG_Bool(REGB2)) {
      /* ../nit/lib/standard/collection/sorter.nit:70 */
      REGB2 = REGB0;
      /* ../nit/lib/standard/collection/array.nit:278 */
      fra.me.REG[2] = fra.me.REG[1];
      REGB3 = REGB0;
      ...
      goto label1;
      label1: while(0);
      /* ../nit/lib/standard/collection/sorter.nit:72 */
      REGB3 = REGB0;
      /* ../nit/lib/standard/collection/sorter.nit:73 */
      while(1) {
        ...
        if (UNTAG_Bool(REGB4)) {
          ...
          goto label2;
          label2: while(0);
          /* ../nit/lib/standard/collection/sorter.nit:74 */
          ...
          /* ../nit/lib/standard/collection/sorter.nit:74 */
          if (UNTAG_Bool(REGB5)) {
            /* ../nit/lib/standard/collection/sorter.nit:75 */
            REGB2 = REGB3;
            /* ../nit/lib/standard/collection/array.nit:278 */
            fra.me.REG[3] = fra.me.REG[1];
            REGB5 = REGB3;
		...
		nit_abort("Cast failed", NULL, LOCATE_standard___kernel, 0);
            ...
            goto label3;
            label3: while(0);
            /* ../nit/lib/standard/collection/sorter.nit:76 */
            fra.me.REG[2] = fra.me.REG[3];
          }
          /* ../nit/lib/standard/collection/sorter.nit:78 */
          REGB5 = TAG_Int(1);
          /* ../nit/lib/standard/kernel.nit:238 */
      ...
      label4: while(0);
      /* ../nit/lib/standard/collection/sorter.nit:80 */
...
val_t standard___collection___sorter___ComparableSorter___compare(val_t p0, val_t p1, val_t p2){
  ...
  fra.me.REG[1] = p1;
  fra.me.REG[2] = p2;
  /* ../nit/lib/standard/collection/sorter.nit:94 */
