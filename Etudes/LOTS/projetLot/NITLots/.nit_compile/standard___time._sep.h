/* This C header file is generated by NIT to compile modules and programs that requires ../nit/lib/standard/time. */
...
static const char LOCATE_standard___time___Object___get_time[];
