...
val_t standard___hash___Bool___hash(val_t p0){
  ...
  fra.me.nitni_local_ref_head = NULL;
  REGB0 = p0;
  /* ../nit/lib/standard/hash.nit:38 */
  if (UNTAG_Bool(REGB0)) {
    /* ../nit/lib/standard/hash.nit:39 */
    REGB0 = TAG_Int(1);
    goto label1;
  } else {
    /* ../nit/lib/standard/hash.nit:41 */
    REGB1 = TAG_Int(0);
    REGB0 = REGB1;
    goto label1;
  }
