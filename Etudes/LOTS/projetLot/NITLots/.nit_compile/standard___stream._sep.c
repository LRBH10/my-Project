...
void standard___stream___IOS___close(val_t p0){
  ...
  /* ../nit/lib/standard/stream.nit:20 */
...
val_t standard___stream___IStream___read_char(val_t p0){
  ...
  fra.me.REG_size = 0;
  fra.me.nitni_local_ref_head = NULL;
  /* ../nit/lib/standard/stream.nit:27 */
...
val_t standard___stream___IStream___read(val_t p0, val_t p1){
  ...
  label1: while(0);
  /* ../nit/lib/standard/stream.nit:41 */
...
val_t standard___stream___IStream___read_line(val_t p0){
  ...
  fra.me.REG[1] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/stream.nit:47 */
...
val_t standard___stream___IStream___read_all(val_t p0){
  ...
  fra.me.REG[1] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/stream.nit:56 */
  fra.me.REG[1] = NEW_Buffer_standard___string___Buffer___init();
  /* ../nit/lib/standard/stream.nit:57 */
  while(1) {
    REGB0 = CALL_standard___stream___IStream___eof(fra.me.REG[0])(fra.me.REG[0]);
    REGB0 = TAG_Bool(!UNTAG_Bool(REGB0));
    if (UNTAG_Bool(REGB0)) {
      /* ../nit/lib/standard/stream.nit:58 */
      REGB0 = CALL_standard___stream___IStream___read_char(fra.me.REG[0])(fra.me.REG[0]);
      /* ../nit/lib/standard/stream.nit:59 */
      REGB1 = TAG_Int(0);
      REGB2 = TAG_Bool(VAL_ISA(REGB1, VTCOLOR_standard___kernel___Comparable___OTHER(REGB0), VTID_standard___kernel___Comparable___OTHER(REGB0))) /*cast OTHER*/;
      if (UNTAG_Bool(REGB2)) {
      } else {
  ...
  label1: while(0);
  /* ../nit/lib/standard/stream.nit:61 */
  fra.me.REG[1] = CALL_standard___string___Object___to_s(fra.me.REG[1])(fra.me.REG[1]);
  goto label2;
  label2: while(0);
  stack_frame_head = fra.me.prev;
...
void standard___stream___IStream___append_line_to(val_t p0, val_t p1){
  ...
  fra.me.REG[0] = p0;
  fra.me.REG[1] = p1;
  /* ../nit/lib/standard/stream.nit:67 */
  while(1) {
    /* ../nit/lib/standard/stream.nit:68 */
    REGB0 = CALL_standard___stream___IStream___read_char(fra.me.REG[0])(fra.me.REG[0]);
    /* ../nit/lib/standard/stream.nit:69 */
    REGB1 = TAG_Int(1);
    ...
    if (UNTAG_Bool(REGB2)) {
      /* ../nit/lib/standard/stream.nit:70 */
...
val_t standard___stream___IStream___eof(val_t p0){
  ...
  fra.me.REG_size = 0;
  fra.me.nitni_local_ref_head = NULL;
  /* ../nit/lib/standard/stream.nit:79 */
...
void standard___stream___OStream___write(val_t p0, val_t p1){
  ...
  fra.me.REG_size = 0;
  fra.me.nitni_local_ref_head = NULL;
  /* ../nit/lib/standard/stream.nit:86 */
...
val_t standard___stream___OStream___is_writable(val_t p0){
  ...
  fra.me.REG_size = 0;
  fra.me.nitni_local_ref_head = NULL;
  /* ../nit/lib/standard/stream.nit:89 */
...
val_t standard___stream___BufferedIStream___read_char(val_t p0){
  ...
  fra.me.REG[1] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/stream.nit:98 */
  REGB0 = CALL_standard___stream___IStream___eof(fra.me.REG[0])(fra.me.REG[0]);
  REGB0 = TAG_Bool(!UNTAG_Bool(REGB0));
  if (UNTAG_Bool(REGB0)) {
  } else {
  ...
  /* ../nit/lib/standard/stream.nit:99 */
  ...
  /* ../nit/lib/standard/stream.nit:102 */
  if (UNTAG_Bool(REGB0)) {
    /* ../nit/lib/standard/stream.nit:103 */
    REGB0 = TAG_Int(1);
    /* ../nit/lib/standard/kernel.nit:239 */
  ...
  /* ../nit/lib/standard/stream.nit:105 */
  fra.me.REG[1] = ATTR_standard___stream___BufferedIStream____buffer(fra.me.REG[0]);
  REGB1 = TAG_Bool(ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB1)) {
  } else {
  ...
  /* ../nit/lib/standard/stream.nit:106 */
  ...
  /* ../nit/lib/standard/stream.nit:107 */
  REGB0 = REGB1;
  goto label1;
  label1: while(0);
  stack_frame_head = fra.me.prev;
...
val_t standard___stream___BufferedIStream___read(val_t p0, val_t p1){
  ...
  fra.me.REG[0] = p0;
  REGB0 = p1;
  /* ../nit/lib/standard/stream.nit:112 */
  fra.me.REG[1] = NEW_Buffer_standard___string___Buffer___with_capacity(REGB0);
  /* ../nit/lib/standard/stream.nit:113 */
  REGB1 = TAG_Bool(ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB1)) {
  } else {
  ...
  REGB1 = ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0]);
  /* ../nit/lib/standard/stream.nit:114 */
  ...
  /* ../nit/lib/standard/stream.nit:115 */
  while(1) {
    REGB3 = TAG_Int(0);
    ...
    if (UNTAG_Bool(REGB3)) {
      ...
      /* ../nit/lib/standard/stream.nit:116 */
      if (UNTAG_Bool(REGB3)) {
        /* ../nit/lib/standard/stream.nit:117 */
        CALL_standard___stream___BufferedIStream___fill_buffer(fra.me.REG[0])(fra.me.REG[0]);
        /* ../nit/lib/standard/stream.nit:118 */
        ...
        /* ../nit/lib/standard/stream.nit:119 */
        ...
        REGB1 = REGB3;
        /* ../nit/lib/standard/stream.nit:120 */
      ...
      /* ../nit/lib/standard/stream.nit:122 */
      while(1) {
        REGB3 = TAG_Bool(VAL_ISA(REGB2, VTCOLOR_standard___kernel___Comparable___OTHER(REGB1), VTID_standard___kernel___Comparable___OTHER(REGB1))) /*cast OTHER*/;
        if (UNTAG_Bool(REGB3)) {
        } else {
        ...
        if (UNTAG_Bool(REGB3)) {
          /* ../nit/lib/standard/stream.nit:123 */
          fra.me.REG[3] = ATTR_standard___stream___BufferedIStream____buffer(fra.me.REG[0]);
          REGB3 = TAG_Bool(fra.me.REG[3]==NIT_NULL);
          if (UNTAG_Bool(REGB3)) {
          ...
          /* ../nit/lib/standard/stream.nit:124 */
          REGB3 = TAG_Int(1);
          /* ../nit/lib/standard/kernel.nit:238 */
          REGB3 = TAG_Int(UNTAG_Int(REGB1)+UNTAG_Int(REGB3));
          /* ../nit/lib/standard/stream.nit:124 */
          REGB1 = REGB3;
          /* ../nit/lib/standard/stream.nit:125 */
          REGB3 = TAG_Int(1);
          /* ../nit/lib/standard/kernel.nit:240 */
...
val_t standard___stream___BufferedIStream___read_all(val_t p0){
  ...
  fra.me.REG[2] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/stream.nit:134 */
  fra.me.REG[1] = NEW_Buffer_standard___string___Buffer___init();
  /* ../nit/lib/standard/stream.nit:135 */
  while(1) {
    REGB0 = CALL_standard___stream___IStream___eof(fra.me.REG[0])(fra.me.REG[0]);
    REGB0 = TAG_Bool(!UNTAG_Bool(REGB0));
    if (UNTAG_Bool(REGB0)) {
      /* ../nit/lib/standard/stream.nit:136 */
      REGB0 = TAG_Bool(ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0])!=NIT_NULL);
      if (UNTAG_Bool(REGB0)) {
      } else {
      ...
      REGB0 = ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0]);
      /* ../nit/lib/standard/stream.nit:137 */
      fra.me.REG[2] = ATTR_standard___stream___BufferedIStream____buffer(fra.me.REG[0]);
      ...
      /* ../nit/lib/standard/stream.nit:138 */
      while(1) {
        REGB2 = TAG_Bool(VAL_ISA(REGB1, VTCOLOR_standard___kernel___Comparable___OTHER(REGB0), VTID_standard___kernel___Comparable___OTHER(REGB0))) /*cast OTHER*/;
        if (UNTAG_Bool(REGB2)) {
        } else {
        ...
        /* ../nit/lib/standard/stream.nit:138 */
        if (UNTAG_Bool(REGB2)) {
          /* ../nit/lib/standard/stream.nit:139 */
          fra.me.REG[2] = ATTR_standard___stream___BufferedIStream____buffer(fra.me.REG[0]);
          REGB2 = TAG_Bool(fra.me.REG[2]==NIT_NULL);
          if (UNTAG_Bool(REGB2)) {
          ...
          /* ../nit/lib/standard/stream.nit:140 */
          REGB2 = TAG_Int(1);
          /* ../nit/lib/standard/kernel.nit:238 */
  ...
  label2: while(0);
  /* ../nit/lib/standard/stream.nit:145 */
  fra.me.REG[1] = CALL_standard___string___Object___to_s(fra.me.REG[1])(fra.me.REG[1]);
  goto label3;
  label3: while(0);
  stack_frame_head = fra.me.prev;
...
void standard___stream___BufferedIStream___append_line_to(val_t p0, val_t p1){
  ...
  fra.me.REG[0] = p0;
  fra.me.REG[1] = p1;
  /* ../nit/lib/standard/stream.nit:150 */
  while(1) {
    /* ../nit/lib/standard/stream.nit:152 */
    REGB0 = TAG_Bool(ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0])!=NIT_NULL);
    if (UNTAG_Bool(REGB0)) {
    } else {
    ...
    REGB0 = ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0]);
    /* ../nit/lib/standard/stream.nit:153 */
    while(1) {
      fra.me.REG[2] = ATTR_standard___stream___BufferedIStream____buffer(fra.me.REG[0]);
      REGB1 = TAG_Bool(fra.me.REG[2]==NIT_NULL);
      if (UNTAG_Bool(REGB1)) {
    ...
    label1: while(0);
    /* ../nit/lib/standard/stream.nit:156 */
    REGB3 = TAG_Bool(ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0])!=NIT_NULL);
    if (UNTAG_Bool(REGB3)) {
    } else {
    ...
    if (UNTAG_Bool(REGB3)) {
      ...
      /* ../nit/lib/standard/stream.nit:158 */
      ...
      /* ../nit/lib/standard/stream.nit:161 */
      REGB2 = TAG_Bool(ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0])!=NIT_NULL);
      if (UNTAG_Bool(REGB2)) {
      } else {
      ...
      REGB2 = ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0]);
      /* ../nit/lib/standard/stream.nit:162 */
      while(1) {
        ...
        /* ../nit/lib/standard/stream.nit:162 */
        if (UNTAG_Bool(REGB3)) {
          /* ../nit/lib/standard/stream.nit:163 */
          fra.me.REG[2] = ATTR_standard___stream___BufferedIStream____buffer(fra.me.REG[0]);
          ...
          CALL_standard___collection___abstract_collection___SimpleCollection___add(fra.me.REG[1])(fra.me.REG[1], REGB3);
          /* ../nit/lib/standard/stream.nit:164 */
          REGB3 = TAG_Int(1);
          /* ../nit/lib/standard/kernel.nit:238 */
          REGB3 = TAG_Int(UNTAG_Int(REGB2)+UNTAG_Int(REGB3));
          /* ../nit/lib/standard/stream.nit:164 */
    ...
    /* ../nit/lib/standard/stream.nit:168 */
    fra.me.REG[2] = ATTR_standard___stream___BufferedIStream____buffer(fra.me.REG[0]);
    REGB2 = TAG_Bool(fra.me.REG[2]==NIT_NULL);
    if (UNTAG_Bool(REGB2)) {
    ...
    /* ../nit/lib/standard/stream.nit:168 */
    if (UNTAG_Bool(REGB2)) {
      /* ../nit/lib/standard/stream.nit:170 */
      REGB2 = TAG_Int(1);
      /* ../nit/lib/standard/kernel.nit:238 */
      REGB2 = TAG_Int(UNTAG_Int(REGB0)+UNTAG_Int(REGB2));
      /* ../nit/lib/standard/stream.nit:170 */
      ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0]) = REGB2;
      /* ../nit/lib/standard/stream.nit:171 */
      goto label3;
    } else {
      /* ../nit/lib/standard/stream.nit:174 */
      ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0]) = REGB0;
      /* ../nit/lib/standard/stream.nit:175 */
      REGB0 = CALL_standard___stream___BufferedIStream___end_reached(fra.me.REG[0])(fra.me.REG[0]);
      if (UNTAG_Bool(REGB0)) {
        /* ../nit/lib/standard/stream.nit:176 */
        goto label3;
      } else {
        /* ../nit/lib/standard/stream.nit:178 */
        CALL_standard___stream___BufferedIStream___fill_buffer(fra.me.REG[0])(fra.me.REG[0]);
      }
    }
  }
...
val_t standard___stream___BufferedIStream___eof(val_t p0){
  ...
  fra.me.REG[1] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/stream.nit:184 */
  REGB0 = TAG_Bool(ATTR_standard___stream___BufferedIStream____buffer_pos(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
...
void standard___stream___BufferedIStream___fill_buffer(val_t p0){
  ...
  fra.me.REG_size = 0;
  fra.me.nitni_local_ref_head = NULL;
  /* ../nit/lib/standard/stream.nit:192 */
...
val_t standard___stream___BufferedIStream___end_reached(val_t p0){
  ...
  fra.me.REG_size = 0;
  fra.me.nitni_local_ref_head = NULL;
  /* ../nit/lib/standard/stream.nit:195 */
...
val_t standard___stream___FDStream___fd(val_t p0){
  ...
  fra.me.REG[0] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/stream.nit:215 */
...
void standard___stream___FDStream___close(val_t p0){
  ...
  fra.me.REG[0] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/stream.nit:218 */
...
val_t standard___stream___FDStream___native_close(val_t p0, val_t p1){
  ...
  fra.me.REG[0] = p0;
  REGB0 = p1;
  /* ../nit/lib/standard/stream.nit:220 */
...
val_t standard___stream___FDStream___native_read_char(val_t p0, val_t p1){
  ...
  fra.me.REG[0] = p0;
  REGB0 = p1;
  /* ../nit/lib/standard/stream.nit:221 */
...
val_t standard___stream___FDStream___native_read(val_t p0, val_t p1, val_t p2, val_t p3){
  ...
  fra.me.REG[1] = p2;
  REGB1 = p3;
  /* ../nit/lib/standard/stream.nit:222 */
...
val_t standard___stream___FDStream___native_write(val_t p0, val_t p1, val_t p2, val_t p3){
  ...
  fra.me.REG[1] = p2;
  REGB1 = p3;
  /* ../nit/lib/standard/stream.nit:223 */
...
void standard___stream___FDStream___init(val_t p0, val_t p1, int* init_table){
  ...
  fra.me.REG[0] = p0;
  REGB0 = p1;
  /* ../nit/lib/standard/stream.nit:225 */
...
val_t standard___stream___FDIStream___read_char(val_t p0){
  ...
  /* ../nit/lib/standard/stream.nit:237 */
  goto label1;
  label1: while(0);
  stack_frame_head = fra.me.prev;
  return REGB0;
...
val_t standard___stream___FDOStream___is_writable(val_t p0){
  ...
  fra.me.REG[0] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* ../nit/lib/standard/stream.nit:246 */
...
void standard___stream___FDOStream___write(val_t p0, val_t p1){
  ...
  fra.me.REG[0] = p0;
  fra.me.REG[1] = p1;
  /* ../nit/lib/standard/stream.nit:250 */
  REGB0 = CALL_standard___stream___FDStream___fd(fra.me.REG[0])(fra.me.REG[0]);
  ...
  /* ../nit/lib/standard/kernel.nit:235 */
  REGB0 = TAG_Bool(UNTAG_Int(REGB1)<UNTAG_Int(REGB0));
  /* ../nit/lib/standard/stream.nit:251 */
  if (UNTAG_Bool(REGB0)) {
    REGB0 = TAG_Bool(false);
...
void standard___stream___FDOStream___init(val_t p0, val_t p1, int* init_table){
  ...
  CALL_standard___stream___FDStream___init(fra.me.REG[0])(fra.me.REG[0], REGB0, init_table);
  /* ../nit/lib/standard/stream.nit:256 */
  REGB0 = TAG_Bool(true);
...
val_t standard___stream___Object___poll(val_t p0, val_t p1){
  ...
  if (UNTAG_Bool(REGB0)) {
    /* ../nit/lib/standard/stream.nit:290 */
    fra.me.REG[2] = NIT_NULL;
    goto label2;
  } else {
    /* ../nit/lib/standard/stream.nit:292 */
  ...
  void OC_standard___stream___Object___poll_1(struct stack_frame_t *closctx, val_t p0, struct stack_frame_t *closctx_param, fun_t clos_fun0){
    ...
    fun_t CREG[1];
    val_t tmp;
    /* ../nit/lib/standard/stream.nit:279 */
    fra.me.prev = stack_frame_head; stack_frame_head = &fra.me;
    fra.me.file = LOCATE_standard___stream;
    fra.me.line = 0;
    fra.me.meth = LOCATE_standard___stream___Object___poll;
    ...
    fra.me.REG[0] = p0;
    CREG[0] = clos_fun0;
    /* ../nit/lib/standard/stream.nit:280 */
    REGB0 = CALL_standard___stream___FDStream___fd(fra.me.REG[0])(fra.me.REG[0]);
    /* ../nit/lib/standard/stream.nit:281 */
    ...
    /* ../nit/lib/standard/stream.nit:282 */
    ...
    /* ../nit/lib/standard/stream.nit:284 */
...
val_t standard___stream___Object___intern_poll(val_t p0, val_t p1, val_t p2){
  ...
  fra.me.REG[1] = p1;
  fra.me.REG[2] = p2;
  /* ../nit/lib/standard/stream.nit:296 */
