/* This C header file is generated by NIT to compile modules and programs that requires ../nit/lib/standard/gc. */
...
static const char LOCATE_standard___gc___Sys___force_garbage_collection[];
