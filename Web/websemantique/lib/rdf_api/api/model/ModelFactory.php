...
class ModelFactory {
     ...
     * @access	public
     */
    static function & getDefaultDbModel($baseURI = null) {
     ...
     * @access	public
     */
    static function & getDbModel($dbStore, $baseURI = null) {
     ...
     * @access	public
     */
    static function & getDbStore($dbDriver = ADODB_DB_DRIVER, $host = ADODB_DB_HOST, $dbName = ADODB_DB_NAME, $user = ADODB_DB_USER, $password = ADODB_DB_PASSWORD) {
     ...
     * @access	public
     */
    static function & getInfModelF($baseURI = null) {
     ...
     * @access	public
     */
    static function & getInfModelB($baseURI = null) {
     ...
     * @access	public
     */
    static function & getResModel($modelType, $baseURI = null) {
        switch ($modelType) {
            case DBMODEL:
     ...
     * @access	public
     */
    static function &getResModelForBaseModel(&$baseModel) {
     ...
     * @access	public
     */
    static function & getOntModel($modelType, $vocabulary, $baseURI = null) {
        switch ($modelType) {
            case DBMODEL:
                $baseModel = ModelFactory::getDefaultDbModel($baseURI);
                break;
     ...
     * @access	public
     */
    static function &getOntModelForBaseModel(&$baseModel, $vocabulary) {
     ...
     * @access	public
     */
    static function & getSparqlClient($server) {
